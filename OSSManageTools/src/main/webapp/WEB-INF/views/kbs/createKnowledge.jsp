    ...
    <div class="layui-col-lg6">
        <form class="layui-form layui-form-pane" action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="knowledgeTitle" id="knowledgeTitle" lay-verify="required" autocomplete="off"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="hidden" name="knowledgeFileName" lay-verify="required" placeholder="知识点内容" id="knowledgeFileName" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['form', 'laydate', 'layer', 'upload'], function () {
        ...
        form.on('submit(submit)', function(data){
            var loadIndex;
            $.ajax({
                url: '../../../controller/service/kbs/createKnowledge.do',
                method: 'POST',
